...
=======
=======
>>>>>>> ae65593 (add the backend code for create the new post and create a new code file in server folder called post.js)
const postRouter = express.Router();
=======
=======
const postRouter = express.Router()
...
>>>>>>> 5294e32 (add the backend code for create the new post and create a new code file in server folder called post.js)
